...
export default function App() {
  ...
  return(
    <div style={{minHeight:"100vh",background:"#000000",color:"#ededed",fontFamily:"Inter,-apple-system,sans-serif",maxWidth:"100%",margin:"0 auto",padding:"0 0 90px"}}>
      ...
      {/* ── HEADER ── */}
      <div style={{padding:"20px 0 0",borderBottom:`1px solid ${"#1a1a1a"}`,paddingBottom:16,marginBottom:20}}>
